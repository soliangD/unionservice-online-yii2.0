$(function () {
  ...
  QUnit.test('should fire slide event with direction', function (assert) {
    ...
    var carouselHTML = '<div id="myCarousel" class="carousel slide">'
        ...
        + '</div>'
        + '</div>'
        + '<a class="left carousel-control" href="#myCarousel" data-slide="prev"></a>'      //左边下一张图片部分 去掉了&lsaquo;
        + '<a class="right carousel-control" href="#myCarousel" data-slide="next"></a>' //右边下一张图片部分 去掉了&lsaquo;
        + '</div>'
    var $carousel = $(carouselHTML)
  ...
  QUnit.test('should fire slid event with direction', function (assert) {
    ...
    var carouselHTML = '<div id="myCarousel" class="carousel slide">'
        ...
        + '</div>'
        + '</div>'
        + '<a class="left carousel-control" href="#myCarousel" data-slide="prev"></a>'       //&lsaquo;
        + '<a class="right carousel-control" href="#myCarousel" data-slide="next"></a>'   //&rsaquo;
        + '</div>'
    var $carousel = $(carouselHTML)
  ...
  QUnit.test('should set interval from data attribute', function (assert) {
    ...
    var templateHTML = '<div id="myCarousel" class="carousel slide">'
        ...
        + '</div>'
        + '</div>'
        + '<a class="left carousel-control" href="#myCarousel" data-slide="prev"></a>'   //左边下一张图片部分  ，把尖括号去掉了&lsaquo;
        + '<a class="right carousel-control" href="#myCarousel" data-slide="next"></a>' //右边，把尖括号去掉&rsaquo;
        + '</div>'
